...
void sdlxx::core::Scene::finish() { setFinished(true); }

bool sdlxx::core::Scene::hasIntent() const { return intent != nullptr; }

const std::string& sdlxx::core::Scene::getTitle() const { return title; }

bool sdlxx::core::Scene::isInitialized() const { return initialized; }

bool sdlxx::core::Scene::isFinished() const { return finished; }

bool sdlxx::core::Scene::isPaused() const { return paused; }
...
void sdlxx::core::Scene::setPaused(bool state) { paused = state; }
